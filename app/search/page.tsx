...
import { Filter, LayoutGrid, List, SearchIcon, SlidersHorizontal } from "lucide-react"
...
export default function SearchResultsPage({ searchParams }: { searchParams: { q?: string } }) {
  const query = searchParams.q || "abstract"
    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-950 via-purple-950/80 to-gray-950">
      <div className="container px-4 py-8 md:px-6 md:py-12">
        <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="text-purple-200">
              Showing results for "<span className="font-medium text-purple-400">{query}</span>"
            </p>
          </div>
          <div className="flex w-full items-center gap-2 md:w-auto">
            <div className="relative flex-1 md:w-[300px]">
              <SearchIcon className="absolute left-2.5 top-2.5 h-4 w-4 text-purple-300" />
              <Input
                type="search"
                placeholder="Search content..."
                defaultValue={query}
                className="w-full rounded-full border-purple-700 bg-gray-900 pl-8 text-purple-200 focus-visible:ring-purple-500"
              />
            </div>
            <Button
              variant="outline"
        ...
        <div className="mb-6 flex items-center gap-2 overflow-x-auto pb-2">
          <Badge variant="outline" className="border-purple-700 bg-purple-900/50 text-purple-200">
            All Results
          </Badge>
          <Badge variant="outline" className="border-purple-700 bg-gray-900 text-purple-200 hover:bg-purple-900/30">
            Images
          </Badge>
          <Badge variant="outline" className="border-purple-700 bg-gray-900 text-purple-200 hover:bg-purple-900/30">
            Videos
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-2">
            ...
            <Select defaultValue="all">
              ...
              <SelectContent className="border-purple-700 bg-gray-900 text-purple-200">
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm text-purple-200">Showing 1-24 of 156 results</p>
            <Tabs defaultValue="grid" className="w-[120px]">
              <TabsList className="grid h-8 w-full grid-cols-2 border-purple-700 bg-gray-900">
                <TabsTrigger
                  value="grid"
            ...
            {Array.from({ length: 12 }).map((_, i) => (
              <Link key={i} href={`/content/${i + 1}`} className="group">
                <div className="overflow-hidden rounded-lg border border-purple-500/30 bg-gray-900 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
                  ...
                  <div className="p-4">
                    <h3 className="font-medium text-white">Abstract Content {i + 1}</h3>
                  ...
                  <div className="flex flex-1 flex-col justify-between p-4">
                    <div>
                      ...
                      <p className="mt-2 line-clamp-2 text-sm text-purple-200">
                        This premium abstract digital content features high-quality visuals perfect for your creative
                        projects.
                      </p>
                    </div>
        ...
        <div className="mt-8 flex justify-center">
          <nav className="flex items-center gap-1">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-8 w-8 border-purple-700 bg-purple-800 p-0 text-white hover:bg-purple-900/50 hover:text-white"
            >
              1
            </Button>
            <Button
              variant="outline"
              size="sm"
              className="h-8 w-8 border-purple-700 bg-gray-900 p-0 text-purple-200 hover:bg-purple-900/50 hover:text-white"
            >
              2
            </Button>
            <Button

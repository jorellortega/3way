...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-950 via-purple-950/80 to-gray-950">
      ...
      <section className="py-12 md:py-16 lg:py-20 relative">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <Link
                key={item}
                href={`/content/${item}`}
                className="group relative overflow-hidden rounded-lg border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.15)]"
              >
          ...
          <div className="flex justify-center">
            <Link href="/browse">
              <Button variant="outline" size="lg" className="border-purple-500 text-purple-200 hover:bg-purple-900/50">
                View All Content
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
      ...
      {/* Top Creators */}
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-purple-950/50 via-gray-950 to-purple-950/50 relative">
        <div className="absolute inset-0 bg-grid-white/[0.02] -z-10"></div>
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <div className="inline-block rounded-lg bg-purple-900/50 px-3 py-1 text-sm text-purple-200 border border-purple-700/50">
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map((creator) => (
              <Link key={creator} href={`/creators/${creator}`} className="group">
                <div className="flex flex-col items-center space-y-3">
                  <div className="relative h-24 w-24 overflow-hidden rounded-full border-2 border-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.3)] md:h-32 md:w-32">
                    <Image
                  ...
                  <div className="text-center">
                    ...
                    <div className="mt-1 flex items-center justify-center">
                      ...
                      <span className="ml-1 text-sm text-purple-200">4.9</span>
                    </div>
                    <p className="mt-1 text-xs text-purple-300">1.2k subscribers</p>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-12 md:py-16 lg:py-20 relative">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3 lg:gap-8">
            {/* Basic Plan */}
            <div className="flex flex-col rounded-lg border border-purple-500/30 bg-gray-900/60 p-6 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-white">Basic</h3>
                <p className="text-sm text-purple-200">For casual browsers</p>
              </div>
              <div className="mb-4">
                <span className="text-4xl font-bold text-white">$9.99</span>
                <span className="text-purple-200">/month</span>
              </div>
              <ul className="mb-6 space-y-2 text-sm text-purple-200">
            ...
            {/* Premium Plan */}
            <div className="relative flex flex-col rounded-lg border border-purple-500 bg-gray-900/60 p-6 shadow-[0_0_20px_rgba(168,85,247,0.3)]">
              <div className="absolute -top-4 left-0 right-0 mx-auto w-fit rounded-full bg-purple-600 px-3 py-1 text-xs font-semibold text-white">
                Most Popular
              </div>
              <div className="mb-4">
                <h3 className="text-xl font-bold text-white">Premium</h3>
                <p className="text-sm text-purple-200">For enthusiasts</p>
              </div>
              <div className="mb-4">
            ...
            <div className="flex flex-col rounded-lg border border-purple-500/30 bg-gray-900/60 p-6 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
              <div className="mb-4">
                ...
                <p className="text-sm text-purple-200">For professionals</p>
              </div>
              <div className="mb-4">

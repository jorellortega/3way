      ...
      <div className="container px-4 py-8 md:px-6 md:py-12">
        <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="text-blue-200">Discover and purchase premium digital content</p>
          </div>
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm text-blue-200">Showing 1-24 of 256 results</p>
            <Tabs defaultValue="grid" className="w-full">
              <TabsList className="grid h-8 w-[120px] grid-cols-2 bg-gray-900 border-blue-700">
                <TabsTrigger
                  value="grid"
                  className="h-8 w-8 p-0 data-[state=active]:bg-blue-800 data-[state=active]:text-white"
                >
                      ...
                      <div className="overflow-hidden rounded-lg border border-blue-500/30 bg-gray-900 shadow-[0_0_15px_rgba(59,130,246,0.15)]">
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-1 flex items-center justify-between">
                            ...
                            <p className="font-medium text-blue-400">$9.99</p>
                          </div>
                        </div>
                      </div>
                    </Link>
              ...
              <TabsContent value="list" className="mt-6">
                <div className="space-y-4">
                  {Array.from({ length: 8 }).map((_, i) => (
                    <Link key={i} href={`/content/${i + 1}`} className="group">
                      <div className="flex overflow-hidden rounded-lg border border-blue-500/30 bg-gray-900 shadow-[0_0_15px_rgba(59,130,246,0.15)]">
                        ...
                        <div className="flex flex-1 flex-col justify-between p-4">
                          <div>
                            <h3 className="font-medium text-white">Digital Content Title {i + 1}</h3>
                            <p className="mt-1 text-sm text-blue-200">By Creator Name</p>
                          ...
                          <div className="mt-4 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <span className="text-xs text-blue-300">4.8 ★</span>
                              <span className="text-xs text-blue-300">1.2k downloads</span>
                            </div>
                            <p className="font-medium text-blue-400">$9.99</p>
                          </div>
                        </div>
